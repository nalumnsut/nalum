...
export const loadIndustriesPage = () =>
  import("@/pages/communities/industries");
export const loadRecentGradsPage = () =>
  import("@/pages/communities/recentGrads");
...
export const loadExploreCommunities = () =>
  import("@/pages/communities/exploreCommunities");
...
export const loadOtpVerificationPage = () =>
...
export const loadChatPage = () =>
  import("@/pages/dashboard/chat/ChatPage").then((module) => ({
...
// Admin pages
export const loadAdminProtectedRoute = () =>
...
export const loadAdminPostEditor = () =>
  import("@/pages/admin/AdminPostEditor");
...
export const loadQueryManagement = () =>
  import("@/pages/admin/QueryManagement");
export const loadGivingManagement = () =>
  import("@/pages/admin/GivingManagement");
